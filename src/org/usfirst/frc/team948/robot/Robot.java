...
import org.usfirst.frc.team948.robot.commands.autogroups.PostAutoReaquireStack;
...
public class Robot extends IterativeRobot {
	...
	public void teleopInit() {
    	if (SmartDashboard.getBoolean("Post Auto")) {
    		PostAutoReaquireStack postAuto = new PostAutoReaquireStack();
    		postAuto.start();
    	}
    ...
    //	NIVision.IMAQdxGrab(session, frame, 1);
       ...
       // CameraServer.getInstance().setImage(frame);
        ...
        DS2015.launchPad.setOutputs(Integer.MAX_VALUE);
